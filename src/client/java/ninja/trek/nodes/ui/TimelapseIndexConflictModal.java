...
public class TimelapseIndexConflictModal extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        context.centeredText(font, "Index Conflict", centerX, modalTop + 10, 0xFFFFFF);
        String msg = "Index " + index + " is non-follow and already has";
        String msg2 = "node '" + conflicting.name + "' assigned.";
        context.centeredText(font, msg, centerX, modalTop + 28, 0xFFAAAA);
        context.centeredText(font, msg2, centerX, modalTop + 40, 0xFFAAAA);
    }
