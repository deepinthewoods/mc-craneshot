...
public class BlockStateModelGenerator {
	...
	public static BlockStateSupplier createStoneState(
	...
	public final void registerParentedItemModel(Item item, Identifier parentModelId) {
	...
	public static BlockStateSupplier createUvLockedColumnBlockState(
		Block block, TextureMap textureMap, BiConsumer<Identifier, Supplier<JsonElement>> modelCollector
	) {
	...
	public final void registerSingleton(Block block, TextureMap textures, Model model) {
	...
	public final void registerTintableCross(Block block, BlockStateModelGenerator.TintType tintType) {
		this.registerItemModel(block);
		this.registerTintableCrossBlockState(block, tintType);
	}

	public final void registerTintableCross(Block block, BlockStateModelGenerator.TintType tintType, TextureMap texture) {
		this.registerItemModel(block);
		this.registerTintableCrossBlockState(block, tintType, texture);
	}

	public final void registerTintableCrossBlockState(Block block, BlockStateModelGenerator.TintType tintType) {
		TextureMap textureMap = TextureMap.cross(block);
		this.registerTintableCrossBlockState(block, tintType, textureMap);
	}

	public final void registerTintableCrossBlockState(Block block, BlockStateModelGenerator.TintType tintType, TextureMap crossTexture) {
	...
	public final void registerTintableCrossBlockStateWithStages(
		Block block, BlockStateModelGenerator.TintType tintType, Property<Integer> stageProperty, int... stages
	) {
	...
	public final void registerFlowerPotPlant(Block plantBlock, Block flowerPotBlock, BlockStateModelGenerator.TintType tintType) {
	...
	public final void registerDoubleBlock(Block doubleBlock, BlockStateModelGenerator.TintType tintType) {
	...
	public final BlockStateModelGenerator.BuiltinModelPool registerBuiltin(Identifier modelId, Block particleBlock) {
		return new BlockStateModelGenerator.BuiltinModelPool(modelId, particleBlock);
	}

	public final BlockStateModelGenerator.BuiltinModelPool registerBuiltin(Block block, Block particleBlock) {
	...
	public final void registerGlassPane(Block glass, Block glassPane) {
	...
	public final void registerShulkerBox(Block shulkerBox) {
	...
	public final void registerPlantPart(Block plant, Block plantStem, BlockStateModelGenerator.TintType tintType) {
		this.registerTintableCrossBlockState(plant, tintType);
		this.registerTintableCrossBlockState(plantStem, tintType);
	}

	public final void registerBed(Block bed, Block particleSource) {
